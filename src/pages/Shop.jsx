...
const Shop = () => {
  ...
  const shop = [
    { id: 1, image1: 'images/Shop/Product1.jpg', image2: 'images/Shop/Product1-2.jpg', price: 'Rs 1,80000', newPrice: 'Rs 16,000', name: 'IPhone 15', category: 'Mobile', tag: "Sale" },
    { id: 2, image1: 'images/Shop/Product2.jpg', image2: 'images/Shop/Product2-2.jpg', price: 'Rs 28,000', newPrice: 'Rs 16,000', name: 'Smart Band Carbon', category: 'Watch', tag: "New Arrivals" },
    { id: 3, image1: 'images/Shop/Product3.jpg', image2: 'images/Shop/Product3-2.jpg', price: 'Rs 40,000', newPrice: 'Rs 16,000', name: 'Wireless Loud H7i', category: 'Music', },
    { id: 4, image1: 'images/Shop/Product4.jpg', image2: 'images/Shop/Product4-2.jpg', price: 'Rs 8000', newPrice: 'Rs 16,000', name: 'IPhone 15 case', category: 'Cover', tag: "New Arrivals" },
    { id: 5, image1: 'images/Shop/Product5.jpg', image2: 'images/Shop/Product5.jpg', price: 'Rs 8000', newPrice: 'Rs 16,000', name: 'IPhone 15 case', category: 'Cover' },
    { id: 6, image1: 'images/Shop/Product6.jpg', image2: 'images/Shop/Product6.jpg', price: 'Rs 8000', newPrice: 'Rs 16,000', name: 'Mouse 15 ', category: 'Computer Hardware', tag: "Sale" },
  ];
  ...
  return (
    <>
      ...
      {selectedProduct && (
        ...
        {FilterSelect && (
          <>
            <div className=' inset-0 bg-black opacity-50 ' onClick={() => setFilterSelect(null)}></div>
            <div className=" h-full fixed bottom-0 overflow-hidden  z-[100]  container inset-x-0 bg-white border-b border-gray-200 p-4 transition-transform transform translate-y-0 duration-300 ">
              <div className=" lg:w-[30%] lg:px-0  ">
                <div className="  ">
                  <div className="flex justify-between">
                    <div className="lg:flex justify-center lg:mx-2 ">
                      <span className=" font-semibold  md:font-normal">FILTER BY PRICE </span>
                    </div>
                ...
                <div className="lg:mx-9 mb-8 ">
                  <div className="   ">
                    <span className="  font-semibold  md:font-normal">CATEGORIES </span>
                  </div>
                  <input className="border border-gray-300 rounded-md w-[95%] outline-none my-2 px-3 py-2" placeholder="Search Categories" />
                ...
                <div className="lg:mx-9">
                  <span className="  font-semibold  md:font-normal uppercase">Brands </span>
                  <input className="border border-gray-300 rounded-md w-[95%] outline-none my-2 px-3 py-2" placeholder="Search Brands" />
                  <div className="h-[8rem] overflow-y-scroll custom-scrollbar">
                    <div className="my-2">
                      <input type="checkbox" className="mr-2 mt-1  " />
                      <label className="text-gray-700 ">
              ...
              <div className="flex justify-center gap-5">
                <div className="mt-3 text-center">
                  <button className="bg-black text-white  rounded-md px-4 py-1">Filter</button>

                </div>
                <div className="mt-3 text-center">
                  <button className="bg-white border border-black   rounded-md px-4 py-1">Reset Filter</button>
            ...
            <div className="md:w-[70%]">
              <div className='flex justify-between my-4 mt-16 '>
                ...
                <div className="md:hidden block">
                  <div className='  border cursor-pointer border-gray-400 rounded-full  p-3 flex gap-1' onClick={toggleFilter} >
                    <span className='lg:text-lg font-semibold' ><CiFilter /></span>
                  </div>
                </div>
                    ...
                    <div className=' duration-300 hover:scale-105  lg:py-4 rounded-md relative group mb-[2rem]'>
                      ...
                      <div className='absolute top-8 right-5 flex flex-col items-center space-y-2 opacity-0 group-hover:opacity-100 transition-opacity duration-500'>
                        ...
                        <div className="border p-1 bg-white shadow-md border-gray-200 rounded-full">
                          <PiEyeLight className='rounded-full cursor-pointer text-2xl text-gray-500' onClick={()=> toggleProduct(product)} />
                        </div>
                      </div>
                      ...
                      <div className='flex justify-center mt-2 text-center'>
                        <div className="">
                          ...
                          <p className='font-semibold md:text-lg text-red-600'>{product.price}</p>
                          <Link to='/productDetails'>
                            <button
                              className='cursor-pointer my-2 text-center md:text-sm text-xs uppercase underline underline-offset-4    '>
                              view details
                            </button>
                          </Link>
                        </div>
              ...
              <div className="sticky top-8">
                <div className=" mb-8 ">
                  ...
                  <div className="lg:mx-auto mt-4 flex-col justify-center">
                    <Box sx={{ width: 280 }} className='lg:mx-auto px-4 md:pr-24 lg:pr-2'>
                      <Slider
                        getAriaLabel={() => 'Temperature range'}
                        value={value}
                        onChange={handleChange}
