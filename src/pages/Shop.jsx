...
const Shop = () => {
  ...
  const shop = [
    { id: 1, image1: 'images/Shop/Product1.jpg', image2: 'images/Shop/Product1-2.jpg', price: 'Rs 1,80000', newPrice: 'Rs 16,000', name: 'IPhone 15', category: 'Mobile' },
    { id: 2, image1: 'images/Shop/Product2.jpg', image2: 'images/Shop/Product2-2.jpg', price: 'Rs 28,000', newPrice: 'Rs 16,000', name: 'Smart Band Carbon', category: 'Watch' },
    ...
    { id: 4, image1: 'images/Shop/Product4.jpg', image2: 'images/Shop/Product4-2.jpg', price: 'Rs 8000', newPrice: 'Rs 16,000', name: 'IPhone 15 case', category: 'Cover' },
    ...
    { id: 6, image1: 'images/Shop/Product6.jpg',image2: 'images/Shop/Product6.jpg', price: 'Rs 8000', newPrice: 'Rs 16,000', name: 'Mouse 15 ', category: 'Computer Hardware' },
  ];
  ...
  return (
    <>
      <div>
        ...
        {offScreenNav && (
          <div className='fixed inset-0 bg-white opacity-5 z-40' onClick={toggleForm}></div>
        )}
        <div ref={filterRef} className={`fixed text-black top-[2.5rem] right-0 h-full bg-white w-full sm:w-[60%] md:w-[40%] lg:w-[25%] border border-gray-200 p-8 transition-transform transform duration-300 z-40 ${offScreenNav ? 'translate-x-0' : 'translate-x-full'}`}>
          <ul className='mx-auto'>
            ...
            {/* <div className="my-8 mt-8 flex gap-[18rem] cursor-pointer" onClick={descriptionToggle}>
              ...
              <label htmlFor="price" className="block text-sm text-gray-700 lg:flex justify-between">
              ...
              <input
                ...
                style={{
                  background: `linear-gradient(to right, black ${price / 10}%, #EFEEEE ${price / 10}%)`
                }}
              />
            </div>
        ...
        <section className='container'>
          <div className=''>
            <div className='flex my-8 gap-8'>
              <span className='flex font-semibold lg:text-base cursor-pointer'>
                <div className='text-green-900'>P</div>
                <div className='text-blue-800'>M</div>
                <div className='text-green-900'>H</div>
              </span>
              <div className='text-green-900'>Shop</div>
            </div>
          </div>
          <div className='flex justify-between'>
            <div className='text-4xl border cursor-pointer border-gray-400 rounded-full items-center px-8 py-1 flex' onClick={toggleForm}>
      ...
      >
        {selectedOption} <MdOutlineKeyboardArrowDown className='mt-1' />
      </div>
      {isOpen && (
        <div className='absolute top-full left-0 mt-2 w-48 bg-white border border-gray-300 rounded-lg shadow-lg z-10'>
          ...
          <section className='grid grid-cols-4 gap-6 mt-4 container'>
            {shop.map((product) => (
              <div className=' ' key={product.id}>
                ...
                <div className='bg-white border duration-300 hover:shadow-xl shadow-md py-4 rounded-md relative group mb-[2rem]'>
                  ...
                  <Link to='/productDetails'>
                    <div
                      className='cursor-pointer border-2 text-center font-semibold text-sm border-blue-700 p-2 mt-2 rounded-md mx-4 '>
                      VIEW DETAILS
                    </div>
                  </Link>
                </div>
