                  ...
                  <div className="" key={product.id}>
                    ...
                    <div className=" duration-300 hover:scale-105  lg:py-4 rounded-md relative group mb-[2rem]">
                      <div className="bg-white  border border-gray-100">
                        <img
                          src={product.image1}
                          className="transition-opacity aspect-[4/4] duration-500 bg-gray-400 ease-in-out opacity-100 group-hover:opacity-0"
                          alt="Product1"
                        />
                        <img
                          src={product.image2}
                          className="transition-opacity aspect-[4/4] duration-500 ease-in-out opacity-0 absolute top-0 left-0 mt-4 group-hover:opacity-100"
                          alt="Product1"
                        />
                        <span
                          className={`absolute ${
                            product.tag === "Sale"
                              ? "border-[red] border text-[red] left-5 hidden md:block  px-3 py-1 lg:top-8 md:top-3 rounded-md"
                              : product.tag === "New Arrivals"
                              ? "border border-blue-700 text-blue-700 left-5  px-3 py-1 lg:top-8 md:top-3  hidden md:block rounded-md"
                              : ""
                          }  `}
                        >
                          {product.tag}
